namespace ThoughtHaven.AspNetCore.SecurityHeaders
{
    ...
    {
        public string? ContentSecurityPolicy { get; set; } = "default-src 'self'; img-src 'self' data:; script-src 'self' https://js.stripe.com/v3/; style-src 'self' https://fonts.googleapis.com https://stackpath.bootstrapcdn.com; font-src 'self' https://fonts.gstatic.com https://stackpath.bootstrapcdn.com";
